...
def export_combined_direction_shapefile(grid_vectors, file_path, direction_grid_parameters, direction_interpolation):
    shpw = shapefile.Writer(file_path + "combined_" + direction_interpolation, shapeType=shapefile.POLYLINE)
...
def export_direction_shapefile(grid_vectors, file_path, direction_grid_parameters, direction_interpolation):
    ...
    for i in range(len(grid_vectors)):
        ...
        shpw = shapefile.Writer(file_path + str(size) + "m_" + str(min_trees) + "Trees_" + direction_interpolation, shapeType=shapefile.POLYLINE)
        shpw.field('Consistency', 'F', decimal=6)
        shpw.field('Scale', 'N')
